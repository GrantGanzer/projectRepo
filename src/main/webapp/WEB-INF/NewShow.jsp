	...
	<div class="appcontainer">
		...
		<div class="maincontent">
			<form:form action="/shows/new" method="post" modelAttribute="Show">
				...
				<div class="form-group">
					<form:label class="input-group-text" path="payurl">Payment Link (venmo,paypal,cashapp):</form:label>
					<form:input class="form-control" id="payurl" type="text"
						path="payurl" />
					<form:errors class="errors" path="payurl" />
				</div>
				<div class="form-group">
					<form:label class="input-group-text" id="description"
						path="description">Show Description:</form:label>
					<form:errors class="errors" path="description" />
				</div>
				<div class="form-group">
					<form:textarea class="form-control" rows="5" cols="60" type="text"
						path="description" />
				</div>
